/* PiKaOs — create-first-admin screen (auth enabled, zero users — 2026-07-14 spec).
   Shown when /api/setup/status reports needsFirstAdmin: the auth plugin booted ownerless and revived
   a console setup code. The operator proves console access (code) and hand-picks the owner account.
   On success the parent logs in through the NORMAL login flow (onDone → useAuth().login) — this
   screen never touches tokens. All copy via t(key) (firstadmin.* ×3 packs). */
