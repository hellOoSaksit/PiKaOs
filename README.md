...
ระบบดึง **โครงสร้าง URL** ของเว็บ (เมนู + sitemap.xml) ด้วย **lxml** แล้วแปลง slug ของแต่ละ
ลิงก์เป็นคำ — `/en/about-us/corporate-governance` → "corporate governance" — เพราะ slug สะอาด
และเป็นภาษาอังกฤษเสมอ จับคู่กับคำมาตรฐานได้แม่นกว่าข้อความบนหน้า (ลำดับชั้น section→sub มาจาก
path เอง) แล้วใช้ **rapidfuzz** เทียบความคล้าย ได้คะแนน 0–99% ต่อหัวข้อ → จัดเป็น ครบ/ไม่ชัด/ขาด
(เปิด toggle "ค้นลึก" เพื่อกลับไปจับจากข้อความ h2/h3/ลิงก์ทั้งหมดได้)
...
ของแพลตฟอร์ม PiKaOs ที่ใหญ่กว่า ส่วนที่กำลังวางแผนต่อ:
