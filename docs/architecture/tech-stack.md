...
| Web | FastAPI + uvicorn[standard] | 0.115.6 / 0.34.0 |
| DB | SQLAlchemy[asyncio] + asyncpg + Alembic + pgvector | 2.0.36 / 0.30.0 / 1.14.0 / 0.3.6 |
| Validation | pydantic + pydantic-settings | 2.10.4 / 2.7.1 |
| Auth | PyJWT + passlib[argon2] | 2.10.1 / 1.7.4 |
| Cache/queue base | redis (asyncio) | 5.2.1 |
| Object storage | minio | 7.2.13 |
| HTTP client / tests | httpx · pytest · pytest-asyncio | 0.28.1 / 8.3.4 / 0.25.0 |
