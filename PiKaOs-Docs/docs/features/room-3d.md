---
title: Room 3D — Three.js room + procedural avatars
type: feature
status: built
keywords: [three.js, room, avatars, low-poly, life-sim, renderer, furniture, draw3d, orbitcontrols, shadows]
related: [../pikaos-dev-rules.md, ../process/lessons.md, ./compare.md, ../README.md]
summary: >
  Owns the live 3D room renderer + living-agent simulation (Three.js scene, procedural
  avatars, life sim). Read before touching room-three/room-tiles/avatar-style/world build.
updated: 2026-06-20
---
...
- **3D scene** = [`lib/room-three.jsx`](../../../PiKaOs-Core/Frontend/src/lib/room-three.jsx) → built by
  `RoomCanvas` in [`world/build.jsx`](../../../PiKaOs-Core/Frontend/src/screens/world/build.jsx).
...
- **2D iso canvas** = [`lib/room-tiles.jsx`](../../../PiKaOs-Core/Frontend/src/lib/room-tiles.jsx)
  ...
  [`world/CharacterSprite.jsx`](../../../PiKaOs-Core/Frontend/src/screens/world/CharacterSprite.jsx).
- **Avatar identity is shared**:
  [`lib/avatar-style.js`](../../../PiKaOs-Core/Frontend/src/lib/avatar-style.js) `variantOf()` (hash of
